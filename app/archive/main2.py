...
from dose_analysis.isodoses2 import create_isodose_canvas  # en lugar de plot_isodose_map
...
class FilmQADoseMainWindow(QMainWindow):
    ...
    def _add_isodose_tab(self, path):
        fig, canvas = create_isodose_canvas(path)
        # Opcional: asegúrate de que el canvas reciba eventos
